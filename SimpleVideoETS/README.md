...
What is it?
The Codelab uses components such as Video, Swiper, and List to build a single-node video player to implement functions such as video poster carousel, video list display, and video playback.
