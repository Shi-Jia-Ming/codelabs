# 简单图库（eTS）
简介
• 本示例展示了eTS极简声明式UI范式开发的使用，包括中基础组件、容器组件和自定义组件的使用，包括基本用法、自定义组件、参数传递和动画使用。
...
What is it?
This sample demonstrates the use of Ets, including basic, container, and custom components, including basic, custom, parameter passing, and animation.
