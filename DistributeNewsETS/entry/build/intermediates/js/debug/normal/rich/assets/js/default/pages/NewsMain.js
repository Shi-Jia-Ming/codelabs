...
/*!********************************************************************************************************************************!*\
  !*** ../../../../../../HarmonyOS/gitee/codelabs_xllenga/DistributeNewsETS/entry/src/main/ets/default/pages/NewsMain.ets?entry ***!
  \********************************************************************************************************************************/
...
var mediaquery = globalThis.requireNapi('mediaquery') || (isSystemplugin('mediaquery', 'ohos') ? globalThis.ohosplugin.mediaquery : isSystemplugin('mediaquery', 'system') ? globalThis.systemplugin.mediaquery : undefined);
__webpack_require__(/*! ../model/NewsData */ "../../../../../../HarmonyOS/gitee/codelabs_xllenga/DistributeNewsETS/entry/src/main/ets/default/model/NewsData.ets");
...
class NewsMain extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        super(compilerAssignedUniqueChildId, parent);
        this.__isLandscape = new ObservedPropertySimple(false, this, "isLandscape");
        this.addProvidedVar("isLandscape", this.__isLandscape);
        this.newsItems = NewsDataModel_1.getNewsDatas();
        this.__newsData = new ObservedPropertyObject(this.newsItems[0]
        // 监听设备状态：横屏并且宽度大于1500
        , this, "newsData");
        this.addProvidedVar("newsData", this.__newsData);
        this.orientationListener = mediaquery.matchMediaSync('screen and (1500 < width) and (orientation: landscape)');
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params) {
        ...
        if (params.orientationListener !== undefined) {
            this.orientationListener = params.orientationListener;
        }
    }
    aboutToBeDeleted() {
    ...
    render() {
        ...
        let earlierCreatedChild_2 = this.findChildById("2");
        if (earlierCreatedChild_2 == undefined) {
            View.create(new NewsTypeComponent("2", this, { newsItems: this.newsItems }));
        }
        else {
            earlierCreatedChild_2.updateWithValueParams({
        ...
        if (this.isLandscape) {
            ...
            if (earlierCreatedChild_3 == undefined) {
                View.create(new DetailComponent_1.DetailComponent("3", this, {}));
            }
            else {
 ...
 * 主页顶部类型新闻组件
 */
class NewsTypeComponent extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        super(compilerAssignedUniqueChildId, parent);
    ...
    render() {
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new NewsListPage("4", this, { newsItems: this.newsItems }));
        }
        else {
        ...
        TabContent.pop();
        TabContent.create();
        TabContent.tabBar('Health');
        let earlierCreatedChild_5 = this.findChildById("5");
        if (earlierCreatedChild_5 == undefined) {
            View.create(new NewsListPage("5", this, { newsItems: this.newsItems.filter(item => (item.newsType == 'Health')) }));
        }
        else {
            earlierCreatedChild_5.updateWithValueParams({
                newsItems: this.newsItems.filter(item => (item.newsType == 'Health'))
            });
        ...
        TabContent.pop();
        TabContent.create();
        TabContent.tabBar('Finance');
        let earlierCreatedChild_6 = this.findChildById("6");
        if (earlierCreatedChild_6 == undefined) {
            View.create(new NewsListPage("6", this, { newsItems: this.newsItems.filter(item => (item.newsType == 'Finance')) }));
        }
        else {
            earlierCreatedChild_6.updateWithValueParams({
                newsItems: this.newsItems.filter(item => (item.newsType == 'Finance'))
            });
        ...
        TabContent.pop();
        TabContent.create();
        TabContent.tabBar('Technology');
        let earlierCreatedChild_7 = this.findChildById("7");
        if (earlierCreatedChild_7 == undefined) {
            View.create(new NewsListPage("7", this, { newsItems: this.newsItems.filter(item => (item.newsType == 'Technology')) }));
        }
        else {
            earlierCreatedChild_7.updateWithValueParams({
                newsItems: this.newsItems.filter(item => (item.newsType == 'Technology'))
            });
        ...
        TabContent.pop();
        TabContent.create();
        TabContent.tabBar('Sport');
        let earlierCreatedChild_8 = this.findChildById("8");
        if (earlierCreatedChild_8 == undefined) {
            View.create(new NewsListPage("8", this, { newsItems: this.newsItems.filter(item => (item.newsType == 'Sport')) }));
        }
        else {
            earlierCreatedChild_8.updateWithValueParams({
                newsItems: this.newsItems.filter(item => (item.newsType == 'Sport'))
            });
        ...
        TabContent.pop();
        TabContent.create();
        TabContent.tabBar('Internet');
        let earlierCreatedChild_9 = this.findChildById("9");
        if (earlierCreatedChild_9 == undefined) {
            View.create(new NewsListPage("9", this, { newsItems: this.newsItems.filter(item => (item.newsType == 'Internet')) }));
        }
        else {
            earlierCreatedChild_9.updateWithValueParams({
                newsItems: this.newsItems.filter(item => (item.newsType == 'Internet'))
            });
        ...
        TabContent.pop();
        TabContent.create();
        TabContent.tabBar('Game');
        let earlierCreatedChild_10 = this.findChildById("10");
        if (earlierCreatedChild_10 == undefined) {
            View.create(new NewsListPage("10", this, { newsItems: this.newsItems.filter(item => (item.newsType == 'Game')) }));
        }
        else {
            earlierCreatedChild_10.updateWithValueParams({
                newsItems: this.newsItems.filter(item => (item.newsType == 'Game'))
            });
 ...
 * 主页新闻列表组件
 */
class NewsListPage extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        super(compilerAssignedUniqueChildId, parent);
        this.newsItems = undefined;
        this.updateWithValueParams(params);
    ...
    render() {
        Column.create();
        List.create();
        ForEach.create("12", this, ObservedObject.GetRawObject(this.newsItems), item => {
            ListItem.create();
            let earlierCreatedChild_11 = this.findChildById("11");
            if (earlierCreatedChild_11 == undefined) {
                View.create(new NewsListItem("11", this, { newsItem: item }));
            }
            else {
 ...
 * 新闻列表条目组件
 */
class NewsListItem extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        super(compilerAssignedUniqueChildId, parent);
        this.newsItem = undefined;
        this.__isLandscape = this.initializeConsume("isLandscape", "isLandscape");
        this.__newsData = this.initializeConsume("newsData", "newsData");
        this.updateWithValueParams(params);
    }
    updateWithValueParams(params) {
    ...
    render() {
        ...
        Row.create();
        Text.create(this.newsItem.title);
        Text.fontSize(17);
        Text.width("55%");
        Text.height(80);
        Text.maxLines(4);
        Text.margin(10);
        Text.pop();
        Image.create(this.newsItem.imgUrl);
        Image.width("35%");
        Image.height(80);
        Image.margin(10);
        Row.pop();
        Divider.create();
        Divider.vertical(false);
        Divider.color("#dbd8db");
        Divider.strokeWidth(1);
        Column.pop();
    }
}
loadDocument(new NewsMain("1", undefined, {}));

})();

/******/ })()
;
//# sourceMappingURL=NewsMain.js.map