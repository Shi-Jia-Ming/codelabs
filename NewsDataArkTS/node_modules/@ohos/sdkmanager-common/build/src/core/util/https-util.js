...
exports.certificates = fs_1.default.readFileSync(path_1.default.resolve(__dirname, '../../../res/cer/root.pem'), 'utf-8').split(',');
const ciphers = [
...
const createAxiosInstance = (_httpsProxy, _defaultOpt) => {
    const _axiosInstance = axios_1.default.create(_defaultOpt);
    if ((_httpsProxy === null || _httpsProxy === void 0 ? void 0 : _httpsProxy.proxy) || (_httpsProxy === null || _httpsProxy === void 0 ? void 0 : _httpsProxy.httpsProxy)) {
        if (_httpsProxy.proxy) {
            const proxyUrl = new node_url_1.URL(_httpsProxy.proxy);
        ...
        _axiosInstance.interceptors.request.use(config => {
            ...
            const url = new node_url_1.URL(config.url);
            let noProxy = '';
