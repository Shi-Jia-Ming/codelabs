...
class CommonSdkInfoHandler {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (unacceptedLicenses.length >= 1) {
                ...
                const fullNames = componentsToBeInstalled
                    ...
                    .map(component => `${component.getDisplayName()}:${component.getVersion()}`);
    ...
    _installComponents(componentsToBeInstalled, progress) {
        return __awaiter(this, void 0, void 0, function* () {
            for (const component of componentsToBeInstalled) {
                progress.info(`Installing ${component.getDisplayName()}:${component.getVersion()}...`);
                try {
                    yield this.createInstallComponentTask(component).execute(progress);
                }
                catch (e) {
                    if (e instanceof sdk_exception_1.SdkException) {
                        throw new sdk_exception_1.SdkException(`Install ${component.getDisplayName()}:${component.getVersion()} failed`, e.getErrorTip());
                    }
                    else {
                        throw new sdk_exception_1.SdkException(`Install ${component.getDisplayName()}:${component.getVersion()} failed`, new error_tip_1.ErrorTip(e === null || e === void 0 ? void 0 : e.message, '', ''));
                    }
                }
            }
        });
    ...
    _throwNotFoundException(notFoundComponents) {
        ...
        const sdkException = new sdk_exception_1.SdkException('', new error_tip_1.ErrorTip('', `Unable to find the following components:${msg}`, `${os_1.default.EOL}1.Open SDK Manager, download the components, and sync the project.
        ${os_1.default.EOL}2.Alternatively, modify the compileSdkVersion settings in the project-level build-profile.json5 file.`));
