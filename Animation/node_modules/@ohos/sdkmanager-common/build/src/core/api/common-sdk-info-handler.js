            ...
            for (const component of componentsToBeInstalled) {
                ...
                try {
                    ...
                    if (e instanceof sdk_exception_1.SdkException) {
                        return Promise.reject(new sdk_exception_1.SdkException(`Install ${component.getDisplayName()}:${component.getVersion()} failed`, e.getErrorTip()));
                    }
                    else {
                        return Promise.reject(new sdk_exception_1.SdkException(`Install ${component.getDisplayName()}:${component.getVersion()} failed`, new error_tip_1.ErrorTip(e === null || e === void 0 ? void 0 : e.message, e === null || e === void 0 ? void 0 : e.message, '')));
                    }
                }
            }
        });
...
\t\t2.Alternatively, modify the compileSdkVersion settings in the project-level build-profile.json5 file.`));
    ...
    getNotFoundException() {
        return '1.Go to Tools > SDK Manager > SDKs > OpenHarmony, download the components, and sync the project. Open SDK' +
            ' Manager';
    }
    _decoratePath(path) {
