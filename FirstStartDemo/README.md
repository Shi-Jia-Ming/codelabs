# FirstStartDemo
简介
• 利用轻量级数据库和自定义组件模拟应用首次启动时申请隐私协议，使用定时器模拟广告页的效果。
...
What is it?
The lightweight database and user-defined components are used to simulate the application to apply for a privacy protocol when the application is started for the first time, and the timer is used to simulate the effect of the advertisement page. .
